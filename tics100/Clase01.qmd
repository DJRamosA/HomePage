...
- Sumar los numeros 2 y 4.
- Incrementar el 56 en una unidad.
- Ordenar nombres de un cruso segun la primera letra del nombre.
...
- Al terminar, le entrega la hoja a su compañero y el debe seguir las instrucciones. 
- Comparen si lo dibujado coincide con la letra original.


## El objetivo del curso

La idea es que sean capacez de llevar sus ideas a una maquina considerando el paso a paso.

Para esto:

- Identifiquen los elementos que tienen disponibles.
- Qué quieren desarollar.
- Utilicen los elementos basicos para resolver paso a paso.
